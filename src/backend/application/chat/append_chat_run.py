...
class AppendChatRunUseCase:
    ...
    def __init__(
        self,
        *,
        repository: AppendChatRunRepositoryLike,
    ...
    def execute(self, command: AppendChatRunCommand) -> ChatAcceptedResult:
        """継続指示を保存し、実行登録後に受付結果を返す。"""
        ...
        with self._transaction_manager:
            accepted_run = self._repository.append_run(
